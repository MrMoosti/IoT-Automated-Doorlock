...
namespace IoT.Program
{
    ...
    public class Mfrc522Controller : IDisposable
    {
        ...
        public Mfrc522Controller(SpiDevice spiDevice, int resetPin)
        {
            _resetPin = resetPin;
        ...
        private (Status status, byte[] backData, byte backLen) SendCommand(Command command, Span<byte> sendData)
        {
            ...
            WriteSpi(CommIEnReg, (byte)(irqEn | ReadMask));
            ClearBitMask(CommIrqReg, ReadMask);
            SetBitMask(FIFOLevelReg, ReadMask);
            ...
            {
                SetBitMask(BitFramingReg, ReadMask);
            }
            ...
            ClearBitMask(BitFramingReg, ReadMask);
        ...
        public (Status status, byte[] data) AntiCollision()
        {
            ...
            WriteSpi(BitFramingReg, (byte)WriteMask);
